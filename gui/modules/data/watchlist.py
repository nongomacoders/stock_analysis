    ...
    query = """
        SELECT 
            ...
            (SELECT trigger_content FROM action_log a 
                WHERE a.ticker = w.ticker AND a.trigger_type = 'SENS' AND a.is_read = false AND a.dismissed_at IS NULL
            ...
            (SELECT count(*) FROM action_log a 
                WHERE a.ticker = w.ticker AND a.is_read = false AND a.dismissed_at IS NULL) as unread_log_count,
