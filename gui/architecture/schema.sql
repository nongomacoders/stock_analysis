...
(
    ...
    significance character varying(20) COLLATE pg_catalog."default",
    CONSTRAINT action_log_pkey PRIMARY KEY (log_id)
);

COMMENT ON COLUMN public.action_log.significance
    IS 'Significance level for SENS announcements: Low, Medium, or High';
...
(
    ...
    display_name_prefix text COLLATE pg_catalog."default",
    CONSTRAINT ai_cost_log_pkey PRIMARY KEY (cost_id)
);

COMMENT ON TABLE public.ai_cost_log
    IS 'Tracking token usage and USD costs for Vertex AI calls per ticker.';

CREATE TABLE IF NOT EXISTS public.commodity_prices
(
    id bigserial NOT NULL,
    symbol text COLLATE pg_catalog."default" NOT NULL,
    commodity text COLLATE pg_catalog."default" NOT NULL,
    ...
    collected_ts timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS public.commodity_universe
(
    symbol text COLLATE pg_catalog."default" NOT NULL,
    commodity text COLLATE pg_catalog."default" NOT NULL,
...
(
    id bigserial NOT NULL,
    pair text COLLATE pg_catalog."default" NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.fx_universe
(
    pair text COLLATE pg_catalog."default" NOT NULL,
    is_active boolean NOT NULL DEFAULT true,
    priority integer NOT NULL DEFAULT 100,
...
(
    ...
    level_type character varying(20) COLLATE pg_catalog."default",
    level_id integer,
...
CREATE TABLE IF NOT EXISTS public.results_downloads
(
    id bigserial NOT NULL,
    ticker character varying(20) COLLATE pg_catalog."default" NOT NULL,
    release_date date,
    pdf_path text COLLATE pg_catalog."default" NOT NULL,
    pdf_url text COLLATE pg_catalog."default",
    source text COLLATE pg_catalog."default" NOT NULL DEFAULT 'ost'::text,
...
COMMENT ON TABLE public.stock_categories
    IS 'Normalized list of stock categories (e.g., Banks, Mining, Retail)';
...
ALTER TABLE IF EXISTS public.ai_cost_log
    ADD CONSTRAINT ai_cost_log_ticker_fkey FOREIGN KEY (ticker)
    REFERENCES public.stock_details (ticker) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_ai_cost_log_ticker
    ON public.ai_cost_log(ticker);
...
ALTER TABLE IF EXISTS public.price_hit_log
    ADD CONSTRAINT price_hit_log_level_id_fkey FOREIGN KEY (level_id)
    REFERENCES public.stock_price_levels (level_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.results_downloads
    ADD CONSTRAINT results_downloads_ticker_fkey FOREIGN KEY (ticker)
    REFERENCES public.stock_details (ticker) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.stock_details
    ADD CONSTRAINT fk_stock_details_stock_category FOREIGN KEY (stock_category_id)
